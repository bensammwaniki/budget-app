...
export default function DebtsScreen() {
    ...
    const renderItem = ({ item }: { item: Debt }) => {
        ...
        const balance = Number(item.currentBalance || 0) + Number(item.accruedFees || 0);
        ...
        return (
            ...
            >
                    ...
                    <View className="flex-row items-center gap-3">
                        ...
                        >
                            <FontAwesome
                                ...
                                size={18}
                                color={item.type === 'OVERDRAFT' ? '#f97316' : (filter === 'ACTIVE' ? '#ef4444' : '#22c55e')}
                            />
                        </View>
                ...
                {/* Progress Bar (only for fixed debts) */}
                {!item.isRevolving && (
